...
#include <asm/dma.h>
#endif
#ifdef CONFIG_ARCH_AESOP2440	// jdh added
...
#elif defined(CONFIG_ARCH_AESOP2440)	// jdh added
...
#ifdef CONFIG_ARCH_AESOP2440	// initialize CS8900, jdh added
...
#endif
	{
#if !defined(CONFIG_ARCH_IXDP2X01) && !defined(CONFIG_ARCH_AESOP2440)	// jdh modified
...
#ifndef CONFIG_ARCH_AESOP2440	// jdh added
